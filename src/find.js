...
export async function main(ns) {
  ...
  if (serverToFind) {
    ...
    ns.tprint(printPathToServer(serverMap.servers, 'CSEC') + '; root;')
    ns.tprint('')
    ns.tprint(`* avmnite-02h (NiteSec faction)`)
    ns.tprint(printPathToServer(serverMap.servers, 'avmnite-02h') + '; root;')
    ns.tprint('')
    ns.tprint(`* I.I.I.I (The Black Hand faction)`)
    ns.tprint(printPathToServer(serverMap.servers, 'I.I.I.I') + '; root;')
    ns.tprint('')
    ns.tprint(`* run4theh111z (Bitrunners faction)`)
    ns.tprint(printPathToServer(serverMap.servers, 'run4theh111z') + '; root;')
    ns.tprint('')
    ns.tprint(`* w0r1d_d43m0n`)
    ns.tprint(printPathToServer(serverMap.servers, 'w0r1d_d43m0n') + '; root;')
    ns.tprint('')
